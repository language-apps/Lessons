...
public class TranslatePlayPanel extends JPanel implements ActionListener
{
   ...
   private MagnetPlayComponent	magnets;
   ...
   public TranslatePlayPanel(LessonsTranslate lesson)
   {  
      this.lesson = lesson;
      ...
      magnets = new MagnetPlayComponent(lesson, area, phrases);
      ...
      add(magnets, BorderLayout.CENTER);
   ...
   public final LessonPlayControls getControls()
   {
      ...
      LessonPlayControls controls
              = new LessonPlayControls(lesson, popup, "TranslatePlay");
