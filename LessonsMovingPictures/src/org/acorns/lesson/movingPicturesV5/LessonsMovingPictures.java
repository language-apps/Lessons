...
*/
package org.acorns.lesson.movingPicturesV5;
...
public class LessonsMovingPictures extends Lesson implements Serializable
{
   ...
   public LessonsMovingPictures()  { super("Moving Pictures"); }
  
  /********* Method to convert between versions  *************/
   public Lesson convert(float version)  
   { return new org.acorns.lesson.movingPicturesV6.LessonsMovingPictures(this);  }
