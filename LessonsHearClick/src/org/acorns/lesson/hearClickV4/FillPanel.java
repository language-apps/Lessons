...
public class FillPanel extends RootSoundPanel
{
   ...
   public FillPanel(int type, LessonsHearClick lesson, ColorScheme colors)
   {
       this.lesson       = lesson;
       ...
       switch (type)
       {
          case Lesson.SETUP:                
             ...
             soundPanel = new SoundPanel('i', colors, panelSize);
   ...
   /********** Property Change Events from Sound Editor Classes **************/
     public void setAnnotationData(Annotations annotations, JPanel panel) 
     { lesson.setAnnotationData((ImageAnnotationData)annotations); }    
     public Annotations getAnnotationData(JPanel panel)
     {  return lesson.getAnnotationData(panel);
     }
